  ...
  if (!requests.length) {
    return (
      <div className="space-y-4">
        ...
        <div className="rounded-2xl border border-[#e4d9c1] bg-white/70 p-8 text-center">
  ...
  return (
    <div className="space-y-4">
      ...
      {requests.map((request) => {
        ...
        return (
          <div key={request.id} className="rounded-2xl border border-[#e4d9c1] bg-white/70 p-5">
