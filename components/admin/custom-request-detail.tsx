...
function MessageComposer({
  ...
  return (
    <div className="space-y-2.5 rounded-2xl border border-[#e7ddc6] bg-[#fffdf9] p-4">
      <input
        value={subject}
      ...
      <textarea
        ...
        className="w-full resize-none rounded-2xl border border-[#d4c5ab] bg-white px-4 py-3 text-sm leading-relaxed text-forest-900 outline-none focus:border-forest-400"
      />
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
        <div className="space-y-6">
          <div className="card space-y-4 p-6 sm:p-8">
            ...
            <dl className="divide-y divide-[#eee7d8] rounded-2xl border border-[#e7ddc6] bg-[#fffdf9]">
              {rows.map((row) => (
          ...
          <div className="card space-y-3 p-6 sm:p-8">
            ...
            {request.notes?.trim() ? (
              <p className="whitespace-pre-wrap rounded-2xl border border-[#e7ddc6] bg-[#fffdf9] px-4 py-3 text-sm leading-relaxed text-forest-800">
                {request.notes}
              </p>
            ) : (
        ...
        <div className="space-y-6">
          ...
          <div className="card space-y-3 p-6">
            ...
            <div className="rounded-2xl border border-[#e7ddc6] bg-[#fffdf9] px-4 py-3">
