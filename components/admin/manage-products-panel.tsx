    ...
    <div className="card space-y-5 p-6 sm:p-8">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative">
          ...
          {filterOpen ? (
            <div className="absolute right-0 top-[3.25rem] z-20 w-44 space-y-1 rounded-xl border border-[#d7cab2] bg-[#fffaf1] p-2 shadow-[0_4px_12px_rgba(0,0,0,0.06)]">
      ...
      {selected.size > 0 ? (
        <div className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-forest-700 bg-forest-900 px-5 py-3 text-sand-50">
