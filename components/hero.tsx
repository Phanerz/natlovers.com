...
export function Hero({locale, currency}: {locale: Locale; currency: CurrencyCode}) {
  ...
  const panelTransform = useMemo(() => {
    return `perspective(1200px) rotateX(${offset.y * -0.65}deg) rotateY(${offset.x * 0.95}deg) translate3d(${offset.x * 8}px, ${offset.y * 6}px, 0)`;
  }, [offset.x, offset.y]);
  ...
  return (
    <section className="page-enter">
      <div className="hero-stage relative overflow-hidden border-b border-[#efe3cb]/14 shadow-[0_24px_80px_rgba(20,33,22,0.18)]">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <video
            ...
            loop
            playsInline
            poster="https://images.unsplash.com/photo-1512436991641-6745cdb1723f?q=80&w=1800&auto=format&fit=crop"
          >
        ...
        <div className="relative z-10 mx-auto flex h-full w-full max-w-[1680px] flex-col justify-center px-4 py-5 sm:px-6 md:px-8 lg:px-10 xl:px-14">
          <div className="grid h-full items-center gap-[21px] lg:grid-cols-[minmax(0,1.618fr)_minmax(360px,1fr)] lg:gap-[34px] xl:gap-[55px]">
            <div className="flex min-w-0 flex-col justify-center">
              <div className="header-text-shadow inline-flex w-fit rounded-full border border-[#f3e7cf]/38 bg-black/24 px-4 py-2 text-[11px] font-medium uppercase tracking-[0.3em] text-white backdrop-blur-md shadow-[0_8px_18px_rgba(0,0,0,0.22)]">
                {locale === "en" ? "Handcrafted in Indonesia" : "Dibuat tangan di Indonesia"}
              </div>

              <div
                className="museum-panel mt-[21px] rounded-[2.4rem] border border-[#efe3cb]/20 bg-[linear-gradient(135deg,rgba(255,248,238,0.15),rgba(255,255,255,0.08))] px-5 py-6 text-white backdrop-blur-xl shadow-[0_24px_80px_rgba(0,0,0,0.24)] sm:px-7 sm:py-7 lg:px-[34px] lg:py-[34px] xl:px-[55px] xl:py-[34px]"
            ...
            <div className="flex min-w-0 items-center lg:justify-end">
              <div className="floating-panel w-full max-w-[31rem] rounded-[2.1rem] border border-[#f0e5cd]/18 bg-[linear-gradient(180deg,rgba(7,20,14,0.62),rgba(7,20,14,0.28))] p-[13px] text-white backdrop-blur-xl shadow-2xl sm:p-[21px]">
                <div className="overflow-hidden rounded-[1.6rem] border border-[#f0e5cd]/14 bg-white/8 p-[13px]">
                  <div className="grid gap-[13px] sm:grid-cols-[minmax(0,1fr)_144px]">
                    <div className="aspect-[4/5] w-full rounded-[1.2rem] border border-white/12 bg-[url('https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=1200&q=80')] bg-cover bg-center shadow-[0_18px_40px_rgba(0,0,0,0.24)]" />
                    <div className="grid gap-[13px]">
                      <div className="rounded-[1.2rem] border border-white/12 bg-[#efdfbf]/10 p-4">
                        ...
                        <p className="mt-3 font-display text-[1.75rem] leading-none text-white">Simbok Nusantara</p>
                      </div>
