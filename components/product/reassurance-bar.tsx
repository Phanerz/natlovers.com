...
export function ReassuranceBar() {
  return (
    <div className="grid gap-4 divide-y divide-forest-100 rounded-xl border border-forest-100 bg-[#fdfaf3] px-5 py-4 sm:grid-cols-3 sm:divide-x sm:divide-y-0 sm:px-6">
