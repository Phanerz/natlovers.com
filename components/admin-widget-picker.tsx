...
function SelectedWidgetRow({widgetKey, onRemove}: {widgetKey: WidgetKey; onRemove: () => void}) {
  ...
  return (
    <Reorder.Item
      ...
      className="flex items-center gap-3 rounded-xl border border-[#e4d9c1] bg-white/70 p-3"
    ...
    <div>
      ...
      <div className="mt-4 space-y-2">
        {selected.length ? (
          ...
          <p className="rounded-xl border border-dashed border-[#e4d9c1] p-4 text-center text-xs text-forest-500">
