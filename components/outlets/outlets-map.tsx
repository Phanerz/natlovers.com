...
// (Next disallows it directly inside a Server Component), which is the
// only reason this thin wrapper exists separately from outlets-map-inner.
...
export function OutletsMap({
  ...
  return <OutletsMapInner locationList={locationList} highlightedId={highlightedId} onMarkerSelect={onMarkerSelect} />;
}
